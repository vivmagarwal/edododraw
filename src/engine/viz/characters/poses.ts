...
registerCharacterPose("kicking", { about: "kicking a leg forward", emotion: "neutral", armL: [[-0.1, 0.31], [-0.2, 0.24]], armR: [[0.1, 0.31], [0.2, 0.4]], legL: [[-0.05, 0.55], [-0.1, 1.0]], legR: [[0.05, 0.55], [0.2, 0.6], [0.34, 0.52]] });
