...
- Viz templates (74 built-in `viz` types): `src/engine/viz/` (registry, context, `generators/*`); demo catalog `src/site/vizDemos.ts`.
...
- [docs/VISUALIZATIONS_GUIDE.md](docs/VISUALIZATIONS_GUIDE.md) — the 74 `viz` templates: catalog, data model, options, icons, extending.
